...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  const hasEnvGcpProjectId = Boolean(
  ...
  }, [isOpen, initialGeminiKey, initialGcpProjectId, handleKeyDown]);
      ...
      >
        ...
        <div className="px-6 py-4 flex items-center justify-between border-b border-slate-700/50 bg-slate-800/80">
          <h3
            ...
            className="text-xl font-bold flex items-center gap-2 text-slate-100"
          >
            <svg
        ...
        <div className="p-6 space-y-6">
          <div className="bg-indigo-500/10 border border-indigo-500/20 rounded-lg p-3 text-sm text-indigo-300">
            独自のGemini
            APIキーを入力することで翻訳を利用できます。入力したキーはお使いのブラウザ内（ローカル）にのみ保存され、サーバーへ送信されることはありません。
          </div>
              ...
              {hasEnvGeminiKey ? (
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    aria-label={
                      showPassword ? "APIキーを隠す" : "APIキーを表示"
                    }
